...
chrome_options.add_argument("--profile-directory=Defau1t")

# open window

user_data_dir=os.getenv("CHROME_USR_DIR","/home/user/.config/google-chrome/")
driver = uc.Chrome(user_data_dir=user_data_dir,options=chrome_options)
...
load_more()
sleep(15)
test = driver.find_element(By.CLASS_NAME ,"resultsContainer")
importentElement = test.get_attribute("innerHTML")
